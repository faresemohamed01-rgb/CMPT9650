...
def plot_violation_distribution():
  ...
  restaurant_violations_df_clean = apply_model()

  violations_per_facility = (restaurant_violations_df_clean.groupby('FacilityID').size().reset_index(name='TotalViolations'))
